...
public class Schalter_Model extends Model {
	...
	public static void main(java.lang.String[] args) {
		for (i = 0; i < 50; i++) {
			Experiment schalterExperiment = new Experiment("Variante1-ereignis"+i);
			...
			schalterExperiment.tracePeriod(new TimeInstant(0.0), new TimeInstant(600));
			schalterExperiment.debugPeriod(new TimeInstant(0.0), new TimeInstant(600));
